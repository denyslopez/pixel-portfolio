...
const copy = {
  en: {
    ...
    heroEyebrow: "GROWTH INFRASTRUCTURE FOR REAL BUSINESSES",
    heroTitleA: "Find where growth is stuck.",
    heroTitleB: "Build the system that moves it.",
    heroBody: "Denysoft identifies the real growth constraint, then connects product strategy, design, engineering, growth and AI around the system that can actually move it.",
    heroPrimary: "Start with clarity",
    heroSecondary: "See the evidence",
    heroNote: "Canada · United States · El Salvador · Latin America",
  ...
  es: {
    ...
    heroEyebrow: "INFRAESTRUCTURA DE CRECIMIENTO PARA NEGOCIOS REALES",
    heroTitleA: "Encuentra dónde está estancado el crecimiento.",
    heroTitleB: "Construye el sistema que lo mueve.",
    heroBody: "Denysoft identifica la restricción real de crecimiento y conecta estrategia de producto, diseño, ingeniería, crecimiento e IA alrededor del sistema que realmente puede moverla.",
    heroPrimary: "Comenzar con claridad",
    heroSecondary: "Ver la evidencia",
    heroNote: "Canadá · Estados Unidos · El Salvador · Latinoamérica",
